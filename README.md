...
@@@@
### Deployment Logs
docs/screenshots/deployment_logs.txt
@@@@
### Teardown Logs
docs/screenshots/teardown_logs.txt
@@@@
### Screenshots
SQS Dead Letter Queue:
docs/screenshots/sqs.png
@@@@
SNS Notification:
docs/screenshots/sns.png
@@@@
...
@@@@
### Clone Repository
bash git clone https://github.com/gandhisiripuram/aws-autoscale-optimizer.git cd aws-autoscale-optimizer @@@@
@@@@
### Setup Environment
...
@@@@
### Deploy
bash python main_deploy.py @@@@
After execution:
- ALB DNS will be printed
- Access application via browser
@@@@
### Destroy
bash python main_destroy.py @@@@
@@@@
==============================
@@@@
## Skills Demonstrated
